...
#this auto installer is based on freevps.us centos6 nginx auto installer
...
yum -y install mysql-server php56w-fpm php56w-mysql php56w-gd php56w-opcache nginx nano exim syslog-ng cronie
